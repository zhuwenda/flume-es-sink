...
public class ElasticsearchSink extends AbstractSink implements Configurable {
    ...
    public void configure(Context context) {
        ...
        String indexType = context.getString("indexType", "kafka");
    ...
    private void initConfig(Context context){
        this.serialierType = context.getString("serializer.type","default");
    ...
    private String ExtractEvent(Event event) {
        ...
        if("grok".equals(this.serialierType)){
        ...
        }else if("default".equals(this.serialierType)){
            return ExtractEventInDefault(event);
        }else{
            throw new IllegalArgumentException("未知的解析方式");
        }
    ...
    private String ExtractEventInDefault(Event event) {
        Map<String, String> headers = event.getHeaders();
